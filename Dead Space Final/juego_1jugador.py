...
def Puntos(punts):
    mensaje = myfont.render('MUERTES '+str(punts),True,(255,255,0))
...
def escribir(punts):
    ...
    linea=linea+'Enemigo aniquilado : '+str(punts)+" veces  "
...
while run:
    #pausa el prograbma por una cantidad de tiempo 
    pygame.time.delay(1)
